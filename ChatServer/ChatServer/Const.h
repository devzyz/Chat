...
enum MSG_IDS {
    ...
    MSG_MESSAGE_RECEIPT_REPORT_REQ = 1029,
    MSG_MESSAGE_RECEIPT_REPORT_RSP = 1030,
    MSG_MESSAGE_RECEIPT_CHANGED_NOTIFY = 1031,
    MSG_MESSAGE_RECEIPT_SYNC_REQ = 1032,
    MSG_MESSAGE_RECEIPT_SYNC_RSP = 1033,
