...
static constexpr const ::_pb::EnumDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_enum_descriptors_varify_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor* PROTOBUF_NONNULL* PROTOBUF_NULLABLE
    file_level_service_descriptors_varify_2eproto = nullptr;
const ::uint32_t
    TableStruct_varify_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        0x081, // bitmap
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_varify_2eproto = {
    ...
    TableStruct_varify_2eproto::offsets,
    file_level_enum_descriptors_varify_2eproto,
...
constexpr auto GetVarifyReq::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataFull{
      ...
      &descriptor_table_varify_2eproto,
      nullptr,  // tracker
  };
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_varify_2eproto),
         ::std::false_type{});
