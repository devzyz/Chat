...
enum ReqId {
    ...
    ID_MESSAGE_RECEIPT_REPORT_REQ = 1029,
    ID_MESSAGE_RECEIPT_REPORT_RSP = 1030,
    ID_MESSAGE_RECEIPT_CHANGED_NOTIFY = 1031,
    ID_MESSAGE_RECEIPT_SYNC_REQ = 1032,
    ID_MESSAGE_RECEIPT_SYNC_RSP = 1033,
