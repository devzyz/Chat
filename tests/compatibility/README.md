...
This historical bootstrap resolver is retained for future runtime compatibility work.
It is no longer a required CI or release gate. Full N-1 testing is deferred until an
actual upgrade support policy is needed; current protocol and schema tests remain active.
The following describes the optional resolver, not automatic publication requirements.
